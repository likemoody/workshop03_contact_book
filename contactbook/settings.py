...
SECRET_KEY = ')okayom$douv3n#y%k9h1jj%vro3n9ni)o6j_ys45$j$#2guyb'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'string_if_invalid': '!! {%s} < error around template variable !!'  # not in Development
        },
    },
]
